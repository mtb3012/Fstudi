        ...
        switch($act){
            ...
            case 'add':
                ...
                if(isset($addProduct_submit)){
                    product_add($name,$_FILES['image']['name'],$price,$sale,$category,
            ...
            case 'edit':
                ...
                if(isset($editProduct_submit)){
                    if($_FILES['image']['name']!=null){
                        product_edit($id,$name,$_FILES['image']['name'],$price,$sale,$category,
                        $quantity,$description,$hot,$status);
                        move_uploaded_file($_FILES['image']['tmp_name'],'../content/img/'.$_FILES['image']['name']);
                        header('location: ?mod=product&act=list');
                    }else{
                        product_edit($id,$name,$sp['HinhAnh'],$price,$sale,$category,
                        $quantity,$description,$hot,$status);
                        header('location: ?mod=product&act=list');
                    }
